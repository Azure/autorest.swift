    ...
    public func listMultiplePages(
        ...
        let params = RequestParameters(
            ...
            (.uri, "$host", client.endpoint.absoluteString, .skipEncoding), (
                .header,
                "maxresults",
                pagingGetMultiplePagesOptions.maxresults,
                .encode
            ), (.header, "timeout", pagingGetMultiplePagesOptions.timeout, .encode),
            (.header, "accept", "application/json", .encode)
        )
    ...
    public func listOdataMultiplePages(
        ...
        let params = RequestParameters(
            ...
            (.uri, "$host", client.endpoint.absoluteString, .skipEncoding), (
                .header,
                "maxresults",
                pagingGetOdataMultiplePagesOptions.maxresults,
                .encode
            ), (.header, "timeout", pagingGetOdataMultiplePagesOptions.timeout, .encode),
            (.header, "accept", "application/json", .encode)
        )
    ...
    public func getMultiplePagesWithOffset(
        ...
        let params = RequestParameters(
            ...
            (.uri, "$host", client.endpoint.absoluteString, .skipEncoding), (
                .header,
                "maxresults",
                pagingGetMultiplePagesWithOffsetOptions.maxresults,
                .encode
            ), (.path, "offset", pagingGetMultiplePagesWithOffsetOptions.offset, .encode), (
                .header,
                "timeout",
                pagingGetMultiplePagesWithOffsetOptions.timeout,
                .encode
            ), (.header, "accept", "application/json", .encode)
        )
    ...
    public func getMultiplePagesLro(
        ...
        let params = RequestParameters(
            ...
            (.uri, "$host", client.endpoint.absoluteString, .skipEncoding), (
                .header,
                "maxresults",
                pagingGetMultiplePagesLroOptions.maxresults,
                .encode
            ), (.header, "timeout", pagingGetMultiplePagesLroOptions.timeout, .encode),
            (.header, "accept", "application/json", .encode)
        )
