...
public final class HttpFailure {
    ...
    ///     success.
    public func getEmptyError(
        withOptions options: GetEmptyErrorOptions? = nil,
        ...
        // Construct request
        let urlTemplate = "/http/failure/emptybody/error"
    ...
    ///    - completionHandler: A completion handler that receives a status code on
    ///     success.
    public func getNoModelError(
        withOptions options: GetNoModelErrorOptions? = nil,
        completionHandler: @escaping HTTPResultHandler<Bool>
    ) {
        let dispatchQueue = options?.dispatchQueue ?? client.commonOptions.dispatchQueue ?? DispatchQueue.main
        ...
        // Construct request
        let urlTemplate = "/http/failure/nomodel/error"
        guard let requestUrl = client.url(host: "{$host}", template: urlTemplate, params: params),
            let request = try? HTTPRequest(method: .get, url: requestUrl, headers: params.headers) else {
            client.options.logger.error("Failed to construct HTTP request.")
            return
    ...
    ///    - completionHandler: A completion handler that receives a status code on
    ///     success.
    public func getNoModelEmpty(
        withOptions options: GetNoModelEmptyOptions? = nil,
        completionHandler: @escaping HTTPResultHandler<Bool>
    ) {
        let dispatchQueue = options?.dispatchQueue ?? client.commonOptions.dispatchQueue ?? DispatchQueue.main
        ...
        // Construct request
        let urlTemplate = "/http/failure/nomodel/empty"
        guard let requestUrl = client.url(host: "{$host}", template: urlTemplate, params: params),
            let request = try? HTTPRequest(method: .get, url: requestUrl, headers: params.headers) else {
            client.options.logger.error("Failed to construct HTTP request.")
            return
