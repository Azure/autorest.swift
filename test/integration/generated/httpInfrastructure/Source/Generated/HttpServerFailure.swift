...
public final class HttpServerFailure {
    ...
    ///     success.
    public func head501(
        withOptions options: Head501Options? = nil,
        ...
        // Construct request
        let urlTemplate = "/http/failure/server/501"
    ...
    ///     success.
    public func get501(
        withOptions options: Get501Options? = nil,
        completionHandler: @escaping HTTPResultHandler<Void>
    ) {
        let dispatchQueue = options?.dispatchQueue ?? client.commonOptions.dispatchQueue ?? DispatchQueue.main
    ...
    ///     success.
    public func post505(
        withOptions options: Post505Options? = nil,
        completionHandler: @escaping HTTPResultHandler<Void>
    ) {
        let dispatchQueue = options?.dispatchQueue ?? client.commonOptions.dispatchQueue ?? DispatchQueue.main
        ...
        let urlTemplate = "/http/failure/server/505"
        guard let requestUrl = client.url(host: "{$host}", template: urlTemplate, params: params),
    ...
    ///    - completionHandler: A completion handler that receives a status code on
    ///     success.
    public func delete505(
        withOptions options: Delete505Options? = nil,
        completionHandler: @escaping HTTPResultHandler<Void>
    ) {
        let dispatchQueue = options?.dispatchQueue ?? client.commonOptions.dispatchQueue ?? DispatchQueue.main
