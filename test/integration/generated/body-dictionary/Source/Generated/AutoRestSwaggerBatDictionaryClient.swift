...
public final class AutoRestSwaggerBatDictionaryClient: PipelineClient {
    ...
    /// Create a AutoRestSwaggerBatDictionaryClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestSwaggerBatDictionaryClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestSwaggerBatDictionaryClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(
                    for: AutoRestSwaggerBatDictionaryClient.self,
    ...
    public lazy var dictionary = Dictionary(client: self)
