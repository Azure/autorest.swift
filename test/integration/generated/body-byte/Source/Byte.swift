...
public final class Byte {
    ...
    public func getNull(
        ...
        // Construct URL
        guard let urlTemplate = "/byte/null".removingPercentEncoding else {
    ...
    public func getEmpty(
        ...
        // Construct URL
        guard let urlTemplate = "/byte/empty".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func getNonAscii(
        ...
        // Construct URL
        guard let urlTemplate = "/byte/nonAscii".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func put(
        ...
        headers["Accept"] = "application/json"
        // Construct request
        guard let requestBody = try? JSONEncoder().encode(nonAscii) else {
    ...
    public func getInvalid(
        ...
        // Construct URL
        guard let urlTemplate = "/byte/invalid".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
