...
public final class AutoRestPagingTestClient: PipelineClient, PageableClient {
    ...
    /// Create a AutoRestPagingTestClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestPagingTestClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestPagingTestClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: AutoRestPagingTestClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
