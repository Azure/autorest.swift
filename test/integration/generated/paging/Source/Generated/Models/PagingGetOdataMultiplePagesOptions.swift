...
/// Parameter group
public struct PagingGetOdataMultiplePagesOptions: Codable, Equatable {
    // MARK: Properties
    ...
    /// Initialize a `PagingGetOdataMultiplePagesOptions` structure.
    /// - Parameters:
    ...
    /// Initialize a `PagingGetOdataMultiplePagesOptions` structure from decoder
    ...
    /// Encode a `PagingGetOdataMultiplePagesOptions` structure
