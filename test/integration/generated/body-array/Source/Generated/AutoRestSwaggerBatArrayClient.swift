...
public final class AutoRestSwaggerBatArrayClient: PipelineClient {
    ...
    /// Create a AutoRestSwaggerBatArrayClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestSwaggerBatArrayClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestSwaggerBatArrayClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: AutoRestSwaggerBatArrayClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
