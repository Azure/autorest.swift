...
public final class ArrayOperation {
    ...
    public func getNull(
        ...
        completionHandler: @escaping HTTPResultHandler<[Get200ApplicationJsonItemsItem]>
    ) {
        // Construct URL
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        ...
                        let decoded = try decoder.decode([Get200ApplicationJsonItemsItem].self, from: data)
                        dispatchQueue.async {
    ...
    public func getInvalid(
        ...
        completionHandler: @escaping HTTPResultHandler<[Integer]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([Integer].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    public func getBooleanTfft(
        ...
        completionHandler: @escaping HTTPResultHandler<[Boolean]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([Boolean].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    public func getFloatValid(
        ...
        completionHandler: @escaping HTTPResultHandler<[Number]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([Number].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    public func getUuidValid(
        ...
        completionHandler: @escaping HTTPResultHandler<[Uuid]>
    ) {
        // Construct URL
    ...
    public func getDateTimeValid(
        ...
        completionHandler: @escaping HTTPResultHandler<[DateTime]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([DateTime].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    public func getDurationValid(
        ...
        completionHandler: @escaping HTTPResultHandler<[Duration]>
    ) {
        // Construct URL
    ...
    public func getByteValid(
        ...
        completionHandler: @escaping HTTPResultHandler<[ByteArray]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([ByteArray].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    public func getArrayNull(
        ...
        completionHandler: @escaping HTTPResultHandler<[ArrayOfString]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([ArrayOfString].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    ///     success.
    public func put(
        arrayValid: [ArrayOfPutContentSchemaItemsItem],
    ...
    public func getDictionaryNull(
        ...
        completionHandler: @escaping HTTPResultHandler<[DictionaryOfString]>
    ) {
        // Construct URL
        ...
        self.request(request, context: context) { result, httpResponse in
            ...
            case .success:
                ...
                if [
                    ...
                    do {
                        let decoder = JSONDecoder()
                        let decoded = try decoder.decode([DictionaryOfString].self, from: data)
                        dispatchQueue.async {
                            completionHandler(.success(decoded), httpResponse)
                        }
                    } catch {
    ...
    ///     success.
    public func put(
        dictionaryValid: [DictionaryOfString],
