...
public final class StringType {
    ...
    public func getNull(
        ...
        // Construct URL
        guard let urlTemplate = "/string/null".removingPercentEncoding else {
    ...
    public func getEmpty(
        ...
        // Construct URL
        guard let urlTemplate = "/string/empty".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func listMbcs(
        ...
        // Construct URL
        guard let urlTemplate = "/string/mbcs".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func getWhitespace(
        ...
        // Construct URL
        guard let urlTemplate = "/string/whitespace".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func getNotProvided(
        ...
        // Construct URL
        guard let urlTemplate = "/string/notProvided".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func getBase64Encoded(
        ...
        // Construct URL
        guard let urlTemplate = "/string/base64Encoding".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func getBase64UrlEncoded(
        ...
        // Construct URL
        guard let urlTemplate = "/string/base64UrlEncoding".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func getNullBase64UrlEncoded(
        ...
        // Construct URL
        guard let urlTemplate = "/string/nullBase64UrlEncoding".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
