...
public final class AutoRestDateTimeTestClient: PipelineClient {
    ...
    /// Create a AutoRestDateTimeTestClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestDateTimeTestClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestDateTimeTestClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: AutoRestDateTimeTestClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
