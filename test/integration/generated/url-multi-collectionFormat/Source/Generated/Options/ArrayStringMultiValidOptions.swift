...
/// User-configurable options for the `ArrayStringMultiValid` operation.
public struct ArrayStringMultiValidOptions: RequestOptions {
    ...
    /// Initialize a `ArrayStringMultiValidOptions` structure.
    /// - Parameters:
    ///   - arrayQuery: an array of string ['ArrayQuery1', 'begin!*'();:@ &=+$,/?#[]end' , null, ''] using the mult-array format
