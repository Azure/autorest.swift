...
public final class Queries {
    ...
    public func arrayStringMultiNull(
        ...
        // Construct URL
        guard let urlTemplate = "/queries/array/multi/string/null".removingPercentEncoding else {
    ...
    public func arrayStringMultiEmpty(
        ...
        // Construct URL
        guard let urlTemplate = "/queries/array/multi/string/empty".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
    ...
    public func arrayStringMultiValid(
        ...
        // Construct URL
        guard let urlTemplate = "/queries/array/multi/string/valid".removingPercentEncoding else {
            self.options.logger.error("Failed to construct url")
            return
        }
        let pathParams = [
