...
public final class AutoRestNumberTestClient: PipelineClient {
    ...
    /// Create a AutoRestNumberTestClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestNumberTestClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestNumberTestClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: AutoRestNumberTestClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
