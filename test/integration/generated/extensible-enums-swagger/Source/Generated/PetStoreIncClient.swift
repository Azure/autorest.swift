...
public final class PetStoreIncClient: PipelineClient {
    ...
    /// Create a PetStoreIncClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the PetStoreIncClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: PetStoreIncClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: PetStoreIncClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
