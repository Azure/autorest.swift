...
public final class AutoRestReportServiceForAzure {
    public let client: AutoRestReportServiceForAzureClient
    ...
    init(client: AutoRestReportServiceForAzureClient) {
        self.client = client
    ...
    public func getReport(
        ...
        // Construct URL
        guard let urlTemplate = "/report/azure".removingPercentEncoding else {
