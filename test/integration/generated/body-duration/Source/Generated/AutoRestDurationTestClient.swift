...
public final class AutoRestDurationTestClient: PipelineClient {
    ...
    /// Create a AutoRestDurationTestClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestDurationTestClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestDurationTestClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: AutoRestDurationTestClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
    ...
    public lazy var duration = Duration(client: self)
