...
public final class AvailabilitySets {
    public let client: AutoRestParameterFlatteningClient
    ...
    init(client: AutoRestParameterFlatteningClient) {
        self.client = client
    ...
    ///    - avset : The name of the storage availability set.
    ///    - options: A list of options for the operation
    ///    - completionHandler: A completion handler that receives a status code on
    ///     success.
    public func update(
        tags: AvailabilitySetUpdateParameters,
        ...
        // Construct URL
        guard let urlTemplate = "/parameterFlattening/{resourceGroupName}/{availabilitySetName}"
        ...
        // Construct request
        guard let requestBody = try? JSONEncoder().encode(tags) else {
