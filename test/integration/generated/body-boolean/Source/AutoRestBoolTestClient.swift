...
public final class AutoRestBoolTestClient: PipelineClient {
    ...
    /// Create a AutoRestBoolTestClient client.
    /// - Parameters:
    ///   - endpoint: Base URL for the AutoRestBoolTestClient.
    ///   - authPolicy: An `Authenticating` policy to use for authenticating client requests.
    ///   - options: Options used to configure the client.
    public init(
        url: URL? = nil,
        authPolicy: Authenticating,
        withOptions options: AutoRestBoolTestClientOptions
    ) throws {
        ...
        super.init(
            ...
            policies: [
                UserAgentPolicy(for: AutoRestBoolTestClient.self, telemetryOptions: options.telemetryOptions),
                RequestIdPolicy(),
                AddDatePolicy(),
                authPolicy,
                ContentDecodePolicy(),
    ...
    public lazy var boolOperation: BoolOperation = BoolOperation(client: self)
