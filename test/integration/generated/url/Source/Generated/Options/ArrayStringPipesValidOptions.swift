...
/// User-configurable options for the `ArrayStringPipesValid` operation.
public struct ArrayStringPipesValidOptions: RequestOptions {
    ...
    /// Initialize a `ArrayStringPipesValidOptions` structure.
    /// - Parameters:
    ///   - arrayQuery: an array of string ['ArrayQuery1', 'begin!*'();:@ &=+$,/?#[]end' , null, ''] using the pipes-array format
