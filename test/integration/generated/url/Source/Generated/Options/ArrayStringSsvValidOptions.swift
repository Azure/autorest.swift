...
/// User-configurable options for the `ArrayStringSsvValid` operation.
public struct ArrayStringSsvValidOptions: RequestOptions {
    ...
    /// Initialize a `ArrayStringSsvValidOptions` structure.
    /// - Parameters:
    ///   - arrayQuery: an array of string ['ArrayQuery1', 'begin!*'();:@ &=+$,/?#[]end' , null, ''] using the ssv-array format
