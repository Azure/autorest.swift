...
namespace AutoRest.Swift
{
    public class CodeNamerSwift : CodeNamer
    {
        ...
        public virtual IEnumerable<string> AutorestImports => new string[] { PrimaryTypeSwift.GetImportLine(package: "github.com/Azure/go-autorest/autorest") };

        public virtual IEnumerable<string> StandardImports => new string[] 
        { 
            PrimaryTypeSwift.GetImportLine(package: "github.com/Azure/go-autorest/autorest/azure"), 
            PrimaryTypeSwift.GetImportLine(package: "net/http") 
        };

        public virtual IEnumerable<string> PageableImports => new string[] 
        { 
            PrimaryTypeSwift.GetImportLine(package: "net/http"), 
            PrimaryTypeSwift.GetImportLine(package: "github.com/Azure/go-autorest/autorest/to") 
        };

        public virtual IEnumerable<string> ValidationImport => new string[] { PrimaryTypeSwift.GetImportLine(package: "github.com/Azure/go-autorest/autorest/validation") };
        ...
        /// <summary>
        /// Initializes a new instance of CodeNamerSwift.
        /// </summary>
        public CodeNamerSwift()
        {
