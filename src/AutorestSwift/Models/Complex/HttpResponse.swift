...
public struct HttpResponse: ProtocolProtocol {
    // the possible HTTP status codes that this response MUST match one of
    public var statusCodes: [HttpResponseStatusCode]

    // canonical response type (ie, 'json')
    public var knownMediaType: KnownMediaType
    ...
    public var headerGroups: [GroupSchema]?
}
